...
<div class="bg-info py-5">
        ...
        <div class="container text-center">
            ...
            enctype="multipart/form-data">
                ...
                <div class="mb-3">
                <input type="password" class="form-control w-50 m-auto" name="usercpass" placeholder="Enter Confirm Password" required>
                </div>
                <div class="mb-3">
                <input type="file" class="form-control w-50 m-auto" name="photo" required>
                </div>
                <div class="mb-3">
